               ...
               <div class="footer-grid-3">
                  <div class="footer-widget-4">
                     <div class="footer-logo mb-35">
                        <a href="index.php">
                           <img src="assets/imgs/logo/4.png" width="200px" alt="image not found">
                           <!-- <h3>MEDILUXE</h3> -->
                        </a>
                     </div>
                  ...
                  <div class="footer-widget-4">
                     ...
                     <div class="footer-link">
                        <ul>
                           ...
                           <!-- <li><a href="error.php">Return Policy</a></li> -->
                           <!-- <li><a href="error.php">Privacy policy</a></li> -->
                           <!-- <li><a href="faq.php">Shopping FAQs</a></li> -->
                        </ul>
                     </div>
                  </div>
                  <div class="footer-widget-4">
                  ...
                  <div class="footer-widget footer-col-4">
                     ...
                     <div class="footer-info mb-35">
                        <p class="w-75">Pakistan Karachi </p>
                        <div class="footer-info-item d-flex align-items-start pb-15 pt-15">
                           ...
                           <div class="footer-info-text">
                              <a href="">Gulsha-e-Iqbal Block 6</a>
                              <p>Street 04</p>
                           </div>
                        </div>
                        <div class="footer-info-item d-flex align-items-start">
                           ...
                           <div class="footer-info-text">
                              <a class="furniture-clr-hover" href="tel:012-345-6789">+92347 2310655</a>
