                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-content-4">
                                 ...
                                 <div class="banner-btn-wrapper">
                                    <a class="solid-btn" href="product.php">Buy Now<span><i
                                             class="fa-regular fa-angle-right"></i></span></a>
                                    <a class="text-btn" href="product.php">View More<span><i
                                             class="fa-regular fa-angle-right"></i></span></a>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="discount-item text-center">
                                 <div class="discount-content">
                                    ...
                                    <h3><a href="product.php">Medicine</a></h3>
                                 </div>
                           ...
                           <div class="swiper-slide">
                              <div class="discount-item text-center">
                                 <div class="discount-content">
                                    ...
                                    <h3><a href="product.php">Healthcare</a></h3>
                                 </div>
                                 <div class="discount-thumb"
                           ...
                           <div class="swiper-slide">
                              <div class="discount-item text-center">
                                 <div class="discount-content">
                                    ...
                                    <h3><a href="product.php">Value Store</a></h3>
                                 </div>
                                 <div class="discount-thumb"
                           ...
                           <div class="swiper-slide">
                              <div class="discount-item text-center">
                                 <div class="discount-content">
                                    ...
                                    <h3><a href="product.php">Lab test</a></h3>
                                 </div>
                                 <div class="discount-thumb"
                           ...
                           <div class="swiper-slide">
                              <div class="discount-item text-center">
                                 <div class="discount-content">
                                    <span>100% OFF</span>
                                    <h3><a href="product.php">Offers</a></h3>
                                 </div>
                                 <div class="discount-thumb"
                                    data-background="assets/imgs/product/discount/discount-01.png"></div>
                              </div>
      ...
      <section class="seller-area section-space-bottom">
         <div class="container">
            <div class="row gy-5 align-items-end mb-40">
               ...
               <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                  <div class="seller-link text-md-end">
                     <a class="solid-btn" href="product.php">Shop all<span><i
                              class="fa-regular fa-angle-right"></i></span></a>
                  </div>
               </div>
            </div>
            ...
            <?php
               ...
               while ($AllProducts = array_shift($row)) {
                  ?>
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                     <div class="product-item">
                           ...
                           <div class="product-thumb">
                              <a href="#"><img src="../admin-portal/assets/images/products-images/<?php echo htmlspecialchars($AllProducts["image"]) ?>" alt=""></a>
                           </div>
                           ...
                           <div class="product-content">
                              <div class="product-tag">
                                 <span><?php echo htmlspecialchars($AllProducts["category_name"]) ?></span>
                              </div>
                              <h4 class="product-title"><a href="product.php"><?php echo htmlspecialchars($AllProducts["product_name"]) ?></a></h4>
                              <div class="product-price">
                                 <span class="product-old-price"><del>Rs.120</del></span>
                                 <span class="product-new-price"><?php echo htmlspecialchars($AllProducts["price"]) ?></span>
                              </div>
                           </div>
                     </div>
                  </div>
                     ...
                     <div class="swiper-wrapper">
                        <div class="swiper-slide">
                           <div class="product-item">
                              ...
                              <div class="product-thumb">
                                 <a href="product.php"><img src="../admin-portal/assets/images/products-images/arinac.webp"
                                       alt=""></a>
                              </div>
                              <div class="product-action-item">
                                 <button type="button" class="product-action-btn">
                              ...
                              <div class="product-content">
                                 ...
                                 <h4 class="product-title"><a href="product.php">Arinac Forte</a></h4>
                                 <div class="product-price">
                                    <span class="product-old-price"><del>Rs. 120</del></span>
                                    <span class="product-new-price">Rs . 100</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="swiper-slide">
                           <div class="product-item">
                              ...
                              <div class="product-thumb">
                                 <a href="product.php"><img src="../admin-portal/assets/images/products-images/surbex.webp"
                                       alt=""></a>
                              </div>
                              <div class="product-action-item">
                                 <button type="button" class="product-action-btn">
                              ...
                              <div class="product-content">
                                 ...
                                 <h4 class="product-title"><a href="product.php">Surbex Z</a></h4>
                                 <div class="product-price">
                                    <span class="product-old-price"><del>Rs. 138</del></span>
                                    <span class="product-new-price">Rs. 120</span>
                                 </div>
                              </div>
                           </div>
                        </div>
