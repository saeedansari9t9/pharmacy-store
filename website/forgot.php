...
<head>
    ...
    <link rel="icon" href="logincss/images/favicon.png" type="image/x-icon" />
    <link rel="shortcut icon" href="logincss/images/favicon.png" type="image/x-icon" />
        ...
        <div class="full-width-screen">
            <div class="container-fluid">
                <div class="content-detail">
                    <img id="shape1" class="parallax" src="logincss/images/shape1.png">
                    <img id="shape2" class="parallax top" src="logincss/images/shape2.png">
                    <img id="shape4" class="parallax left top" src="logincss/images/shape4.png">
                    <img id="shape5" class="parallax left" src="logincss/images/shape5.png">
                    <img id="shape3" class="parallax top" src="logincss/images/shape3.png">
                    <img id="shape6" class="parallax top" src="logincss/images/shape6.png">
                    <img id="shape7" class="parallax" src="logincss/images/shape7.png">
                    <!-- Forgot form -->
                    <form class="forgot-form" method="post">
                        <div class="imgcontainer">
                            <img src="logincss/images/logo.png" alt="logo" class="avatar">
                        </div>
                        <div class="input-control">
                            ...
                            <div class="login-with-btns">
                                <span class="already-acc">Retern to<a href="login.php"
